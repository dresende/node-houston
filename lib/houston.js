...
module.exports.clearTransports = function () {
	transports.length = 0;
	return this;
};
...
function initTransports() {
	...
	try {
		...
		for (var i = 0; i < items.length; i++) {
			...
			try {
				module.exports[name] = require("./transports/" + name);
			} catch (e) {}
		}
	} catch (e) {}

	if (typeof module.exports.std == "function") {
		module.exports.addTransport(new module.exports.std());
	}
}
...
function saveLogEntry(type, error) {
	return function () {
		...
		this.emit((error ? "error" : "") + "log", type, text, obj);
